    ...
    public class ThrusterAbility : OrganAbility
    {
        ...
        public override Signal Fire(NervousSystem nervousSystem, Organ parent, Signal signal)
        {
            ...
            if (num > 0.5)
            {
                ...
                var socketWorldPos = body.Position + socket.Part.LocalPosition + socket.LocalPosition;

                var dir = body.Position - socketWorldPos;
                dir = socket.Normal;
                ...
                {
                    rigidBody.addForce(dir * mag, socketWorldPos);
                    result = 1;
                }
            }
