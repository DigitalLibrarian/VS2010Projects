...
namespace Forever.Screens
{
    ...
    public class InputState
    {
        ...
        public bool IsKeyUp(Keys key, PlayerIndex playerIndex)
        {
            return (LastKeyboardStates[(int)playerIndex].IsKeyDown(key) &&
                    CurrentKeyboardStates[(int)playerIndex].IsKeyUp(key));
        }


        public virtual bool IsKeyDown(Keys key, PlayerIndex playerIndex)
        {
            return CurrentKeyboardStates[(int)playerIndex].IsKeyDown(key);
        }
