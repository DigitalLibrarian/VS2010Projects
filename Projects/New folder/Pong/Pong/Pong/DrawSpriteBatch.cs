...
namespace Pong
{
    ...
    /// rectangle drawing.
    /// </summary>
    public class DrawSpriteBatch : SpriteBatch
    {
        /// <summary>
        ...
        public DrawSpriteBatch(GraphicsDevice graphicsDevice)
            : base(graphicsDevice)
        {
        ...
        /// <param name="color">The draw color.</param>
        public void DrawRectangle(Rectangle rectangle, Color color, bool filled = false)
        {
